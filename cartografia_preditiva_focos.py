...
for idx, semana_epidemio in enumerate(lista_semanas):
	...
	zero[zero["Semana"] == semana_epidemio["Semana"]].plot(ax = ax, column = "Focos", legend = False, edgecolor = "white", linewidth = 0.05,
		                                         label = "Focos", cmap = "Blues")#"YlOrBr")"BuGn"
