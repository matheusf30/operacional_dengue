...
caminho_dados = f"/home/meteoro/scripts/matheus/operacional_dengue/dados_operacao/{_ANO_FINAL}/interpol/" # CLUSTER
...
merge = f"MERGE_daily_SB_{_ANO_FINAL}_interpol.nc"
samet_tmax = f"SAMET_daily_SB_{_ANO_FINAL}_tmax_interpol.nc"
samet_tmed = f"SAMeT_CPTEC_DAILY_TMED_{_ANO_FINAL}.nc"
samet_tmin = f"SAMET_daily_SB_{_ANO_FINAL}_tmin_interpol.nc"
