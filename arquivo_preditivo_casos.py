...
def monta_dataset2(cidade, previsoes):
	...
	dataset_casos["Semana"] = dataset2["Semana"].copy()#.iloc[-12:]
	print(f"\n{green}dataset_casos:\n{reset}{dataset_casos}")
...
casos_ultimos = casos.copy()#.iloc[-7:,:]
previsao_total = previsao_total.copy()#.iloc[5:,:]
...
previsao_total_vdd = previsao_total.copy()#drop(columns = "index")
