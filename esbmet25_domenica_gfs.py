...
caminho_gfs = f"/media/dados/operacao/gfs/0p50/202502/20250216/" #202410/20241012/ #prec_daily_gfs_2024101212.nc

### Renomeação variáveis pelos arquivos
gfs = "gfs_20250216_total.nc"
prec = "acu_prec.nc"
tmin = "media_tmin.nc"
tmed = "media_temp.nc"
tmax = "media_tmax.nc"
...
### Abrindo Arquivos
gfs = xr.open_dataset(f"{caminho_gfs}{gfs}")
...
print(f"\n{green}municipios\n{reset}{municipios}\n")
#prec
print(f'\n{green}gfs.variables["prate"][:]\n{reset}{gfs.variables["prate"][:]}\n')
print(f'\n{green}gfs.variables["temp2m"][:]\n{reset}{gfs.variables["tmp2m"][:]}\n')
print(f'\n{green}gfs.variables["tmin2m"][:]\n{reset}{gfs.variables["tmin2m"][:]}\n')
print(f'\n{green}gfs.variables["tmax2m"][:]\n{reset}{gfs.variables["tmax2m"][:]}\n')
print(f'\n{green}gfs.variables["prate"][:]\n{reset}{gfs.variables["prate"][:]}\n')
print(f'\n{green}gfs["prate"]\n{reset}{gfs["prate"]}\n')
print(f'\n{green}prec.variables["prate"][:]\n{reset}{prec.variables["prate"][:]}\n')
print(f'\n{green}tmed.variables["temp2m"][:]\n{reset}{tmed.variables["tmp2m"][:]}\n')
print(f'\n{green}tmin.variables["tmin2m"][:]\n{reset}{tmin.variables["tmin2m"][:]}\n')
print(f'\n{green}tmax.variables["tmax2m"][:]\n{reset}{tmax.variables["tmax2m"][:]}\n')
print(f'\n{green}gfs.variables["time"][:]\n{reset}{gfs.variables["time"][:]}\n')
...
prec, prec_se = extrair_centroides(municipios, prec, "prate")
"""
...
"""
tmin, tmin_se = extrair_centroides(municipios, tmin, "tmin2m")
"""
...
"""
tmed, tmed_se = extrair_centroides(municipios, tmed, "tmp2m")
"""
...
"""
tmax, tmax_se = extrair_centroides(municipios, tmax, "tmax2m")
"""
